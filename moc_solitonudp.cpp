/****************************************************************************
** Meta object code from reading C++ file 'solitonudp.h'
**
...
#error "The header file 'solitonudp.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 23, 10), // "msgChanged"
QT_MOC_LITERAL(4, 34, 9), // "readyRead"
QT_MOC_LITERAL(5, 44, 11), // "dispvoltage"
QT_MOC_LITERAL(6, 56, 7) // "disperr"

    },
    "UDPSocket\0dataChanged\0\0msgChanged\0"
    "readyRead\0dispvoltage\0disperr"
};
...
void UDPSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&UDPSocket::dataChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (UDPSocket::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&UDPSocket::msgChanged)) {
                *result = 1;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = _t->dispvoltage(); break;
        case 1: *reinterpret_cast< QString*>(_v) = _t->disperr(); break;
        default: break;
        }
